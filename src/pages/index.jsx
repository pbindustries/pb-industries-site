  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Welcome, <br /> To PBI Web Solutions.
          </BigTitle>
          <Subtitle> Building everything from big-data analytics to static web pages. . .</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="Live Drone Analytics"
              link="https://www.livedroneanalytics.com"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              Promoting US military drone strike transparency.
            </ProjectCard>
            <ProjectCard
              title="Villa In Costa Rica"
              link="https://www.villaincostarica.com"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              Escape to beautiful Costa Rica.
            </ProjectCard>
            <ProjectCard
              title="Philip Bankier's Portfolio"
              link="https://www.behance.net/gallery/43907099/Tomb-Raider"
              bg="linear-gradient(to right, #009245 0%, #FCEE21 100%)"
            >
              Philip Bankier's web portfolio.
            </ProjectCard>
            <ProjectCard
              title="Alex Bankier's Portfolio"
              link="https://www.behance.net/gallery/38068151/Eagle"
              bg="linear-gradient(to right, #D585FF 0%, #00FFEE 100%)"
            >
              Alex Bankier's web portfolio.
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          <Title>About</Title>
          <AboutHero>
            <Avatar src={avatar} alt="PB Industries" />
            <AboutSub>
              Let us help you achieve your dreams!
            </AboutSub>
          </AboutHero>
          <AboutDesc>
            I am a Software/Data Engineer with a passion for the whole Elastic Stack. This company started as a simple web-contacting company so that my early web-dev contracts could be official. Now this company is developing multiple open-source web-apps, and one proprietary hardware-software project. We have also built and are currently managing four public websites.
          </AboutDesc>
        </Inner>
      </Content>
